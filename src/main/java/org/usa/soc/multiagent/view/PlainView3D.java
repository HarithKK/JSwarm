...
public class PlainView3D {
    ...
    public PlainView3D(String title, int w, int h){
        this.initComponents(title, w, h);
    }

    public PlainView3D(String title, int w, int h, Algorithm algorithm){
        this.initComponents(title, w, h);
        this.initAlgorithm(algorithm, algorithm.getMargins());
    }

    public PlainView3D(String title, int w, int h, Algorithm algorithm, Margins m){
        this.initComponents(title, w, h);
