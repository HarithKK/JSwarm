...
public class ShiftedSphereFunction extends ObjectiveFunction {

    private double fBias = -450.0;
    private RealMatrix fShift;

    public ShiftedSphereFunction() {
    ...
    public ObjectiveFunction updateDimensions(int n){
        ...
        fShift = new FileHandler("src/main/java/examples/si/benchmarks/cecdata/cec2005/data_sphere.txt").read().toRealMatrix().getSubMatrix(0,0, 0, 29);
    ...
    public Double call() {
        ...
        return BaseFunctions.SphereFunction(rw, fBias, numberOfDimensions);
    }
