...
public class HybridFunction2 extends ObjectiveFunction {
    ...
    public ObjectiveFunction updateDimensions(int n){
        ...
        fShift = new FileHandler("src/main/java/examples/si/benchmarks/cecdata/cec2017/shift_data_11.txt").read().toRealMatrix().getSubMatrix(0,0, 0, 29);
        fMatrix = new FileHandler("src/main/java/examples/si/benchmarks/cecdata/cec2017/M_11_D30.txt").read().toRealMatrix();
        fShuffle = new FileHandler("src/main/java/examples/si/benchmarks/cecdata/cec2017/shuffle_data_11_D30.txt").read().toRealMatrix();
