...
public class CompositeFunction1 extends ObjectiveFunction {
    ...
    double[] lambdas = new double[]{1.0, 0.000006, 1.0};
    ...
    public ObjectiveFunction updateDimensions(int n){
        ...
        fShift = new FileHandler("src/main/java/examples/si/benchmarks/cecdata/cec2017/shift_data_21.txt").read().toRealMatrix().getSubMatrix(0,0, 0, 29);
        fMatrix = new FileHandler("src/main/java/examples/si/benchmarks/cecdata/cec2017/M_21_D30.txt").read().toRealMatrix();
        fShuffle = new FileHandler("src/main/java/examples/si/benchmarks/cecdata/cec2017/shuffle_data_21_D30.txt").read().toRealMatrix();
    ...
    public Double call() {
        ...
        double g2 = lambdas[2] * BaseFunctions.RastriginsFunction(rw2, bias[2], numberOfDimensions);
