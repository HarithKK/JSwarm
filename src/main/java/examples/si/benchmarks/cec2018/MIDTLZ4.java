...
public class MIDTLZ4 extends ObjectiveFunction {
    ...
    public Double call() {
        ...
        for(int i=0; i<dtlz.M; i++){
            fs.add((Math.pow(a, i+1)*(1 - dtlz.calculateCosSinProduct(X.getSubVector(0, dtlz.M-i).mapMultiplyToSelf(1.570)))* (1 + g)));
        }
