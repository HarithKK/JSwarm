...
public class L2T15 {
    ...
    public void L2T5Raft(RepetitionInfo t) {
        try{
            ...
            Core.executeForwardRaft(m, "L2T15", t.getCurrentRepetition(), 150, 350);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void L2T5Random(RepetitionInfo t) {
        try{
            Main m = new Main(15, 5, 2, 15,0.001, 0.0001, WalkType.FORWARD);
            Core.executeForwardRandom(m, "L2T15", t.getCurrentRepetition(), 150, 350);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void L2T5GHS(RepetitionInfo t) {
        try{
            Main m = new Main(15, 5, 2, 15,0.001, 0.0001, WalkType.FORWARD);
            Core.executeForwardGHS(m, "L2T15", t.getCurrentRepetition(), 150, 350);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
    ...
    public void L2T5TSOA(RepetitionInfo t) {
        try{
            Main m = new Main(15, 5, 2, 15,0.001, 0.0001, WalkType.FORWARD);
            Core.executeForwardTSOA(m, "L2T15", t.getCurrentRepetition(), 150, 350);
        }catch (Exception e){
            e.printStackTrace();
        }
    }
