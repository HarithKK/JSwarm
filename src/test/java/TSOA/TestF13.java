...
import org.usa.soc.benchmarks.DynamicMultiModalObjectiveFunctions.Function12;
import org.usa.soc.benchmarks.DynamicMultiModalObjectiveFunctions.Function13;
import ui.AlgoStore;
import utils.Utils;
...
public class TestF13 {
    ...
    String filepath = "data/result_f10.csv";

    String testName = "F10";

    public ObjectiveFunction getFunction(){
        return new Function13(n);
    }
