...
import examples.si.benchmarks.cec2005.ShiftedRotatedGriewanksFunctionwithoutBounds;
...
public class Test_F42_CEC2005_ShiftedRotatedGriewanksFunctionwithoutBounds {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedRotatedGriewanksFunctionwithoutBounds().updateDimensions(n);
    }
