...
public class Test_F43_CEC2005_ShiftedRotatedAckleysFunctionwithGlobalOptimumonBounds {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedRotatedAckleysFunctionwithGlobalOptimumonBounds().updateDimensions(n);
    }
