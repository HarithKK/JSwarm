...
import examples.si.benchmarks.cec2005.ShiftedRosenbrockFunction;
...
public class Test_F40_CEC2005_ShiftedRosenbrockFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedRosenbrockFunction().updateDimensions(n);
    }
