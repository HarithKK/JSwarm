...
import examples.si.benchmarks.cec2005.ShiftedRotatedHighConditionedEllipticFunction;
...
public class Test_F41_CEC2005_ShiftedRotatedHighConditionedEllipticFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedRotatedHighConditionedEllipticFunction().updateDimensions(n);
    }
