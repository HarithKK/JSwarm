...
import examples.si.benchmarks.cec2005.ShiftedSchwefel12Function;
...
public class Test_F39_CEC2005_ShiftedSchwefel12 {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedSchwefel12Function().updateDimensions(n);
    }
