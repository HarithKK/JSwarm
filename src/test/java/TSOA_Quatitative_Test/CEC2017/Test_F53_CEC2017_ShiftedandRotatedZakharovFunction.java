...
import examples.si.benchmarks.cec2017.ShiftedandRotatedZakharovFunction;
...
public class Test_F53_CEC2017_ShiftedandRotatedZakharovFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandRotatedZakharovFunction().updateDimensions(n);
    }
