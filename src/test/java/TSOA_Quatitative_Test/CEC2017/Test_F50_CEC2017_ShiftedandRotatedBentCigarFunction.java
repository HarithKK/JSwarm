...
import examples.si.benchmarks.cec2017.ShiftedandRotatedBentCigarFunction;
...
public class Test_F50_CEC2017_ShiftedandRotatedBentCigarFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandRotatedBentCigarFunction().updateDimensions(n);
    }
