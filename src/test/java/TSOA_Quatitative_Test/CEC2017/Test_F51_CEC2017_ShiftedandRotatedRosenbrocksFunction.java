...
import examples.si.benchmarks.cec2017.ShiftedandRotatedRastriginsFunction;
import examples.si.benchmarks.cec2017.ShiftedandRotatedRosenbrocksFunction;
...
public class Test_F51_CEC2017_ShiftedandRotatedRosenbrocksFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandRotatedRosenbrocksFunction().updateDimensions(n);
    }
