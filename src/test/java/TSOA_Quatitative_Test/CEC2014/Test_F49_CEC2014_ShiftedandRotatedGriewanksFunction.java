...
import examples.si.benchmarks.cec2014.ShiftedandRotatedGriewanksFunction;
...
public class Test_F49_CEC2014_ShiftedandRotatedGriewanksFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandRotatedGriewanksFunction().updateDimensions(n);
    }
