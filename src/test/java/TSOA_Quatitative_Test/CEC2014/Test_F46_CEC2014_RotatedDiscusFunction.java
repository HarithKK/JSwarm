...
import examples.si.benchmarks.cec2014.RotatedDiscusFunction;
...
public class Test_F46_CEC2014_RotatedDiscusFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new RotatedDiscusFunction().updateDimensions(n);
    }
