...
import examples.si.benchmarks.cec2014.ShiftedandRotatedAckleyFunction;
...
public class Test_F48_CEC2014_ShiftedandRotatedAckleyFunction {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandRotatedAckleyFunction().updateDimensions(n);
    }
