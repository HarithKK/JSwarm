...
import examples.si.benchmarks.nonGeneral.classical.unimodal.separable.StepintFunction;
...
public class Test_F3_CUS_Stepin {
    int n = 30;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new StepintFunction().updateDimensions(n);
    }
