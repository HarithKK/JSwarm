...
import examples.si.benchmarks.cec2018.MIDTLZ6;
import examples.si.benchmarks.cec2022.ShiftedandRotatedRosenbrockFunction;
...
public class Test_F65_CEC2022_ShiftedandRotatedRosenbrockFunction {
    int n = 20;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandRotatedRosenbrockFunction().updateDimensions(n);
    }
