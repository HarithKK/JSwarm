...
public class Test_F67_CEC2022_ShiftedandFullRotatedNonContinuousRastrigin {
    int n = 20;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandRotatedNonContinuousRastriginFunction().updateDimensions(n);
    }
