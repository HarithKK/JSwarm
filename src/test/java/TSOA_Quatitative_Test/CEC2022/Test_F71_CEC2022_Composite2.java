...
import examples.si.benchmarks.cec2022.CompositeFunction1;
import examples.si.benchmarks.cec2022.CompositeFunction2;
...
public class Test_F71_CEC2022_Composite2 {
    int n = 20;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new CompositeFunction2().updateDimensions(n);
    }
