...
import examples.si.benchmarks.cec2022.ShiftedandFullRotatedZakharovFunction;
...
public class Test_F64_CEC2022_ShiftedandfFullRotatedZakharovFunction {
    int n = 20;
    int p = 30;
    int steps = 1000;
    String filepath;
    ...
    public ObjectiveFunction getFunction() {
        return new ShiftedandFullRotatedZakharovFunction().updateDimensions(n);
    }
